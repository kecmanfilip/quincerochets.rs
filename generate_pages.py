...
FOOTER = """<footer class="footer">
  <div class="footer-inner">
    ...
    <div class="footer-social">
      <h4>Prati nas</h4>
      <a href="https://www.instagram.com/quince.crochets" target="_blank" rel="noopener noreferrer" class="footer-insta">
    ...
    <div class="product-detail-grid">
      ...
      <div class="product-info">
        ...
        <div class="product-cta-box">
          ...
          <a href="https://www.instagram.com/quince.crochets" target="_blank" rel="noopener noreferrer" class="btn btn-full" style="background:rgba(255,255,255,0.15);color:#fff;border:1px solid rgba(255,255,255,0.3)">DM na Instagram @quince.crochets</a>
